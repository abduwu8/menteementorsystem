    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black items-center justify-center relative overflow-hidden">
        ...
        <div className="w-full max-w-md text-white text-center relative z-10">
          ...
          <div className="mb-8">
            {/* <div className="w-48 h-48 mx-auto bg-gray-800/50 backdrop-blur-sm rounded-full flex items-center justify-center text-white text-xl font-medium">
              Image Placeholder
            </div> */}
          </div>
          <h1 className="text-4xl font-bold mb-4 tracking-tight">Welcome Back, Mentor!</h1>
          <p className="text-lg text-gray-300 leading-relaxed font-medium">
            Continue your journey of sharing knowledge and guiding others
          </p>
        </div>
      </div>
